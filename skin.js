...
// Generated 周三 3月 5 16:28:20 2025
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._container_2.appendChild(me._image_1);
		...
		me._container_1.appendChild(me._image_9);
		...
		me._container_1.appendChild(me._marker_1);
		...
		me._container_1.appendChild(me._marker_2);
		...
		me._container_1.appendChild(me._marker_3);
		...
		me._container_1.appendChild(me._marker_4);
		...
		me._container_1.appendChild(me._marker_5);
		el=me._marker_6=document.createElement('div');
		el.ggMarkerNodeId='{node47}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 6";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._container_1.appendChild(me._marker_6);
		el=me._marker_7=document.createElement('div');
		el.ggMarkerNodeId='{node48}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 7";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._container_1.appendChild(me._marker_7);
		el=me._marker_8=document.createElement('div');
		el.ggMarkerNodeId='{node52}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 8";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._container_1.appendChild(me._marker_8);
		el=me._marker_9=document.createElement('div');
		el.ggMarkerNodeId='{node78}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 9";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._marker_9.onclick=function (e) {
			player.openNext('{node78}');
		}
		me._marker_9.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_9);
		el=me._marker_10=document.createElement('div');
		el.ggMarkerNodeId='{node50}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 10";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._container_1.appendChild(me._marker_10);
		el=me._marker_11=document.createElement('div');
		el.ggMarkerNodeId='{node79}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 11";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._container_1.appendChild(me._marker_11);
		el=me._marker_12=document.createElement('div');
		...
		me._marker_12.onclick=function (e) {
			player.openNext('{node61}');
		}
		me._marker_12.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_12);
		el=me._marker_13=document.createElement('div');
		el.ggMarkerNodeId='{node81}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 13";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._marker_13.onclick=function (e) {
			player.openNext('{node81}');
		}
		me._marker_13.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_13);
		el=me._marker_14=document.createElement('div');
		el.ggMarkerNodeId='{node77}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 14";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._marker_14.onclick=function (e) {
			player.openNext('{node77}');
		}
		me._marker_14.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_14);
		el=me._marker_15=document.createElement('div');
		el.ggMarkerNodeId='{node86}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 15";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._marker_15.onclick=function (e) {
			player.openNext('{node86}');
		}
		me._marker_15.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_15);
		el=me._marker_16=document.createElement('div');
		el.ggMarkerNodeId='{node74}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 16";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._marker_16.onclick=function (e) {
			player.openNext('{node74}');
		}
		me._marker_16.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_16);
		el=me._marker_17=document.createElement('div');
		el.ggMarkerNodeId='{node55}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 17";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._marker_17.onclick=function (e) {
			player.openNext('{node55}');
		}
		me._marker_17.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_17);
		el=me._marker_18=document.createElement('div');
		el.ggMarkerNodeId='{node57}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 18";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._marker_18.onclick=function (e) {
			player.openNext('{node57}');
		}
		me._marker_18.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_18);
		el=me._marker_19=document.createElement('div');
		el.ggMarkerNodeId='{node56}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 19";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._marker_19.onclick=function (e) {
			player.openNext('{node56}');
		}
		me._marker_19.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_19);
		el=me._marker_20=document.createElement('div');
		el.ggMarkerNodeId='{node70}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 20";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._marker_20.onclick=function (e) {
			player.openNext('{node70}');
		}
		me._marker_20.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_20);
		el=me._marker_21=document.createElement('div');
		el.ggMarkerNodeId='{node68}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 21";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._marker_21.onclick=function (e) {
			player.openNext('{node68}');
		}
		me._marker_21.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_21);
		el=me._marker_22=document.createElement('div');
		el.ggMarkerNodeId='{node66}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 22";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		me._marker_22.onclick=function (e) {
			player.openNext('{node66}');
		}
		me._marker_22.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_22);
		el=me._marker_23=document.createElement('div');
		...
		me._marker_23.onclick=function (e) {
			player.openNext('{node63}');
		}
		me._marker_23.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_23);
		el=me._marker_24=document.createElement('div');
		...
		me._marker_24.onclick=function (e) {
			player.openNext('{node20}');
		}
		me._marker_24.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_24);
		el=me._marker_25=document.createElement('div');
		...
		me._marker_25.onclick=function (e) {
			player.openNext('{node18}');
		}
		me._marker_25.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_25);
		el=me._marker_26=document.createElement('div');
		...
		me._marker_26.onclick=function (e) {
			player.openNext('{node31}');
		}
		me._marker_26.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_26);
		el=me._marker_27=document.createElement('div');
		...
		me._marker_27.onclick=function (e) {
			player.openNext('{node16}');
		}
		me._marker_27.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_27);
		el=me._marker_28=document.createElement('div');
		...
		me._marker_28.onclick=function (e) {
			player.openNext('{node13}');
		}
		me._marker_28.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_28);
		el=me._marker_29=document.createElement('div');
		...
		me._marker_29.onclick=function (e) {
			player.openNext('{node10}');
		}
		me._marker_29.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_29);
		el=me._marker_30=document.createElement('div');
		...
		me._marker_30.onclick=function (e) {
			player.openNext('{node37}');
		}
		me._marker_30.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_30);
		el=me._marker_32=document.createElement('div');
		...
		me._marker_32.onclick=function (e) {
			player.openNext('{node34}');
		}
		me._marker_32.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_32);
		el=me._marker_33=document.createElement('div');
		...
		me._marker_33.onclick=function (e) {
			player.openNext('{node33}');
		}
		me._marker_33.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_33);
		el=me._marker_34=document.createElement('div');
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._marker_34.ggIsActive=function() {
			return this.ggIsMarkerActive==true;
		}
		el.ggElementNodeId=function() {
			var hs=String(this.ggMarkerNodeId);
		...
		me._marker_34.onclick=function (e) {
			player.openNext('{node38}');
		}
		me._marker_34.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_34);
		el=me._marker_31=document.createElement('div');
		...
		me._marker_31.onclick=function (e) {
			player.openNext('{node8}');
		}
		me._marker_31.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_31);
		el=me._marker_35=document.createElement('div');
		el.ggMarkerNodeId='{node87}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 35";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._marker_35.ggIsActive=function() {
			return this.ggIsMarkerActive==true;
		}
		el.ggElementNodeId=function() {
			var hs=String(this.ggMarkerNodeId);
		...
		me._marker_35.onclick=function (e) {
			player.openNext('{node87}');
		}
		me._marker_35.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_35);
		el=me._marker_36=document.createElement('div');
		el.ggMarkerNodeId='{node84}';
		el.ggMarkerInstances = [];
		nodeMarker.push(el);
		el.ggId="Marker 36";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._marker_36.ggIsActive=function() {
			return this.ggIsMarkerActive==true;
		}
		el.ggElementNodeId=function() {
			var hs=String(this.ggMarkerNodeId);
		...
		me._marker_36.onclick=function (e) {
			player.openNext('{node84}');
		}
		me._marker_36.ggUpdatePosition=function (useTransition) {
		}
		me._container_1.appendChild(me._marker_36);
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		els.innerHTML="<br\/><br\/>\u8d35<br\/>\u5dde<br\/>\u8d22<br\/>\u7ecf<br\/>\u5927<br\/>\u5b66<br\/>\u897f<br\/>\u533a<br\/>\u5bfc<br\/>\u89c8<br\/>\u56fe";
		el.appendChild(els);
		...
		me._popup_video_youtube.ggVideoNotLoaded = true;
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_1);
		me._marker_1__normal = clonedNormalElement._off;
		...
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_1);
		me._marker_1__active= clonedActiveElement._on;
		...
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_2);
		me._marker_2__normal = clonedNormalElement._off;
		...
		me._marker_2.ggMarkerInstances.push(me._marker_2__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_2);
		me._marker_2__active= clonedActiveElement._on;
		...
		me._marker_2.ggMarkerInstances.push(me._marker_2__active);
		...
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_3);
		me._marker_3__normal = clonedNormalElement._off;
		...
		me._marker_3.ggMarkerInstances.push(me._marker_3__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_3);
		me._marker_3__active= clonedActiveElement._on;
		...
		me._marker_3.ggMarkerInstances.push(me._marker_3__active);
		...
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_4);
		me._marker_4__normal = clonedNormalElement._off;
		me._marker_4__normal.style.visibility='inherit';
		me._marker_4__normal.style.left='0px';
		me._marker_4__normal.style.top='0px';
		me._marker_4.ggMarkerNormal=me._marker_4__normal;
		me._marker_4.ggMarkerInstances.push(me._marker_4__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_4);
		me._marker_4__active= clonedActiveElement._on;
		me._marker_4__active.style.visibility='hidden';
		me._marker_4__active.style.left='0px';
		me._marker_4__active.style.top='0px';
		me._marker_4.ggMarkerActive=me._marker_4__active;
		me._marker_4.ggMarkerInstances.push(me._marker_4__active);
		...
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_5);
		me._marker_5__normal = clonedNormalElement._off;
		me._marker_5__normal.style.visibility='inherit';
		me._marker_5__normal.style.left='0px';
		me._marker_5__normal.style.top='0px';
		me._marker_5.ggMarkerNormal=me._marker_5__normal;
		me._marker_5.ggMarkerInstances.push(me._marker_5__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_5);
		me._marker_5__active= clonedActiveElement._on;
		me._marker_5__active.style.visibility='hidden';
		me._marker_5__active.style.left='0px';
		me._marker_5__active.style.top='0px';
		me._marker_5.ggMarkerActive=me._marker_5__active;
		me._marker_5.ggMarkerInstances.push(me._marker_5__active);
		...
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_6);
		me._marker_6__normal = clonedNormalElement._off;
		me._marker_6__normal.style.visibility='inherit';
		me._marker_6__normal.style.left='0px';
		me._marker_6__normal.style.top='0px';
		me._marker_6.ggMarkerNormal=me._marker_6__normal;
		me._marker_6.ggMarkerInstances.push(me._marker_6__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_6);
		me._marker_6__active= clonedActiveElement._on;
		me._marker_6__active.style.visibility='hidden';
		me._marker_6__active.style.left='0px';
		me._marker_6__active.style.top='0px';
		me._marker_6.ggMarkerActive=me._marker_6__active;
		me._marker_6.ggMarkerInstances.push(me._marker_6__active);
		...
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_7);
		me._marker_7__normal = clonedNormalElement._off;
		me._marker_7__normal.style.visibility='inherit';
		me._marker_7__normal.style.left='0px';
		me._marker_7__normal.style.top='0px';
		me._marker_7.ggMarkerNormal=me._marker_7__normal;
		me._marker_7.ggMarkerInstances.push(me._marker_7__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_7);
		me._marker_7__active= clonedActiveElement._on;
		me._marker_7__active.style.visibility='hidden';
		me._marker_7__active.style.left='0px';
		me._marker_7__active.style.top='0px';
		me._marker_7.ggMarkerActive=me._marker_7__active;
		me._marker_7.ggMarkerInstances.push(me._marker_7__active);
		...
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_8);
		me._marker_8__normal = clonedNormalElement._off;
		me._marker_8__normal.style.visibility='inherit';
		me._marker_8__normal.style.left='0px';
		me._marker_8__normal.style.top='0px';
		me._marker_8.ggMarkerNormal=me._marker_8__normal;
		me._marker_8.ggMarkerInstances.push(me._marker_8__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_8);
		me._marker_8__active= clonedActiveElement._on;
		me._marker_8__active.style.visibility='hidden';
		me._marker_8__active.style.left='0px';
		me._marker_8__active.style.top='0px';
		me._marker_8.ggMarkerActive=me._marker_8__active;
		me._marker_8.ggMarkerInstances.push(me._marker_8__active);
		...
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_9);
		me._marker_9__normal = clonedNormalElement._off;
		me._marker_9__normal.style.visibility='inherit';
		me._marker_9__normal.style.left='0px';
		me._marker_9__normal.style.top='0px';
		me._marker_9.ggMarkerNormal=me._marker_9__normal;
		me._marker_9.ggMarkerInstances.push(me._marker_9__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_9);
		me._marker_9__active= clonedActiveElement._on;
		me._marker_9__active.style.visibility='hidden';
		me._marker_9__active.style.left='0px';
		me._marker_9__active.style.top='0px';
		me._marker_9.ggMarkerActive=me._marker_9__active;
		me._marker_9.ggMarkerInstances.push(me._marker_9__active);
		if (me._marker_9.firstChild) {
			me._marker_9.insertBefore(me._marker_9__active,me._marker_9.firstChild);
		} else {
			me._marker_9.appendChild(me._marker_9__active);
		}
		if (me._marker_9.firstChild) {
			me._marker_9.insertBefore(me._marker_9__normal,me._marker_9.firstChild);
		} else {
			me._marker_9.appendChild(me._marker_9__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_10);
		me._marker_10__normal = clonedNormalElement._off;
		...
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_10);
		me._marker_10__active= clonedActiveElement._on;
		...
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_11);
		me._marker_11__normal = clonedNormalElement._off;
		...
		me._marker_11.ggMarkerInstances.push(me._marker_11__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_11);
		me._marker_11__active= clonedActiveElement._on;
		...
		me._marker_11.ggMarkerInstances.push(me._marker_11__active);
		...
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_12);
		me._marker_12__normal = clonedNormalElement._off;
		me._marker_12__normal.style.visibility='inherit';
		me._marker_12__normal.style.left='0px';
		me._marker_12__normal.style.top='0px';
		me._marker_12.ggMarkerNormal=me._marker_12__normal;
		me._marker_12.ggMarkerInstances.push(me._marker_12__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_12);
		me._marker_12__active= clonedActiveElement._on;
		me._marker_12__active.style.visibility='hidden';
		me._marker_12__active.style.left='0px';
		me._marker_12__active.style.top='0px';
		me._marker_12.ggMarkerActive=me._marker_12__active;
		me._marker_12.ggMarkerInstances.push(me._marker_12__active);
		if (me._marker_12.firstChild) {
			me._marker_12.insertBefore(me._marker_12__active,me._marker_12.firstChild);
		} else {
			me._marker_12.appendChild(me._marker_12__active);
		}
		if (me._marker_12.firstChild) {
			me._marker_12.insertBefore(me._marker_12__normal,me._marker_12.firstChild);
		} else {
			me._marker_12.appendChild(me._marker_12__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_13);
		me._marker_13__normal = clonedNormalElement._off;
		me._marker_13__normal.style.visibility='inherit';
		me._marker_13__normal.style.left='0px';
		me._marker_13__normal.style.top='0px';
		me._marker_13.ggMarkerNormal=me._marker_13__normal;
		me._marker_13.ggMarkerInstances.push(me._marker_13__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_13);
		me._marker_13__active= clonedActiveElement._on;
		me._marker_13__active.style.visibility='hidden';
		me._marker_13__active.style.left='0px';
		me._marker_13__active.style.top='0px';
		me._marker_13.ggMarkerActive=me._marker_13__active;
		me._marker_13.ggMarkerInstances.push(me._marker_13__active);
		if (me._marker_13.firstChild) {
			me._marker_13.insertBefore(me._marker_13__active,me._marker_13.firstChild);
		} else {
			me._marker_13.appendChild(me._marker_13__active);
		}
		if (me._marker_13.firstChild) {
			me._marker_13.insertBefore(me._marker_13__normal,me._marker_13.firstChild);
		} else {
			me._marker_13.appendChild(me._marker_13__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_14);
		me._marker_14__normal = clonedNormalElement._off;
		me._marker_14__normal.style.visibility='inherit';
		me._marker_14__normal.style.left='0px';
		me._marker_14__normal.style.top='0px';
		me._marker_14.ggMarkerNormal=me._marker_14__normal;
		me._marker_14.ggMarkerInstances.push(me._marker_14__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_14);
		me._marker_14__active= clonedActiveElement._on;
		me._marker_14__active.style.visibility='hidden';
		me._marker_14__active.style.left='0px';
		me._marker_14__active.style.top='0px';
		me._marker_14.ggMarkerActive=me._marker_14__active;
		me._marker_14.ggMarkerInstances.push(me._marker_14__active);
		if (me._marker_14.firstChild) {
			me._marker_14.insertBefore(me._marker_14__active,me._marker_14.firstChild);
		} else {
			me._marker_14.appendChild(me._marker_14__active);
		}
		if (me._marker_14.firstChild) {
			me._marker_14.insertBefore(me._marker_14__normal,me._marker_14.firstChild);
		} else {
			me._marker_14.appendChild(me._marker_14__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_15);
		me._marker_15__normal = clonedNormalElement._off;
		me._marker_15__normal.style.visibility='inherit';
		me._marker_15__normal.style.left='0px';
		me._marker_15__normal.style.top='0px';
		me._marker_15.ggMarkerNormal=me._marker_15__normal;
		me._marker_15.ggMarkerInstances.push(me._marker_15__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_15);
		me._marker_15__active= clonedActiveElement._on;
		me._marker_15__active.style.visibility='hidden';
		me._marker_15__active.style.left='0px';
		me._marker_15__active.style.top='0px';
		me._marker_15.ggMarkerActive=me._marker_15__active;
		me._marker_15.ggMarkerInstances.push(me._marker_15__active);
		if (me._marker_15.firstChild) {
			me._marker_15.insertBefore(me._marker_15__active,me._marker_15.firstChild);
		} else {
			me._marker_15.appendChild(me._marker_15__active);
		}
		if (me._marker_15.firstChild) {
			me._marker_15.insertBefore(me._marker_15__normal,me._marker_15.firstChild);
		} else {
			me._marker_15.appendChild(me._marker_15__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_16);
		me._marker_16__normal = clonedNormalElement._off;
		me._marker_16__normal.style.visibility='inherit';
		me._marker_16__normal.style.left='0px';
		me._marker_16__normal.style.top='0px';
		me._marker_16.ggMarkerNormal=me._marker_16__normal;
		me._marker_16.ggMarkerInstances.push(me._marker_16__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_16);
		me._marker_16__active= clonedActiveElement._on;
		me._marker_16__active.style.visibility='hidden';
		me._marker_16__active.style.left='0px';
		me._marker_16__active.style.top='0px';
		me._marker_16.ggMarkerActive=me._marker_16__active;
		me._marker_16.ggMarkerInstances.push(me._marker_16__active);
		if (me._marker_16.firstChild) {
			me._marker_16.insertBefore(me._marker_16__active,me._marker_16.firstChild);
		} else {
			me._marker_16.appendChild(me._marker_16__active);
		}
		if (me._marker_16.firstChild) {
			me._marker_16.insertBefore(me._marker_16__normal,me._marker_16.firstChild);
		} else {
			me._marker_16.appendChild(me._marker_16__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_17);
		me._marker_17__normal = clonedNormalElement._off;
		me._marker_17__normal.style.visibility='inherit';
		me._marker_17__normal.style.left='0px';
		me._marker_17__normal.style.top='0px';
		me._marker_17.ggMarkerNormal=me._marker_17__normal;
		me._marker_17.ggMarkerInstances.push(me._marker_17__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_17);
		me._marker_17__active= clonedActiveElement._on;
		me._marker_17__active.style.visibility='hidden';
		me._marker_17__active.style.left='0px';
		me._marker_17__active.style.top='0px';
		me._marker_17.ggMarkerActive=me._marker_17__active;
		me._marker_17.ggMarkerInstances.push(me._marker_17__active);
		if (me._marker_17.firstChild) {
			me._marker_17.insertBefore(me._marker_17__active,me._marker_17.firstChild);
		} else {
			me._marker_17.appendChild(me._marker_17__active);
		}
		if (me._marker_17.firstChild) {
			me._marker_17.insertBefore(me._marker_17__normal,me._marker_17.firstChild);
		} else {
			me._marker_17.appendChild(me._marker_17__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_18);
		me._marker_18__normal = clonedNormalElement._off;
		me._marker_18__normal.style.visibility='inherit';
		me._marker_18__normal.style.left='0px';
		me._marker_18__normal.style.top='0px';
		me._marker_18.ggMarkerNormal=me._marker_18__normal;
		me._marker_18.ggMarkerInstances.push(me._marker_18__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_18);
		me._marker_18__active= clonedActiveElement._on;
		me._marker_18__active.style.visibility='hidden';
		me._marker_18__active.style.left='0px';
		me._marker_18__active.style.top='0px';
		me._marker_18.ggMarkerActive=me._marker_18__active;
		me._marker_18.ggMarkerInstances.push(me._marker_18__active);
		if (me._marker_18.firstChild) {
			me._marker_18.insertBefore(me._marker_18__active,me._marker_18.firstChild);
		} else {
			me._marker_18.appendChild(me._marker_18__active);
		}
		if (me._marker_18.firstChild) {
			me._marker_18.insertBefore(me._marker_18__normal,me._marker_18.firstChild);
		} else {
			me._marker_18.appendChild(me._marker_18__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_19);
		me._marker_19__normal = clonedNormalElement._off;
		me._marker_19__normal.style.visibility='inherit';
		me._marker_19__normal.style.left='0px';
		me._marker_19__normal.style.top='0px';
		me._marker_19.ggMarkerNormal=me._marker_19__normal;
		me._marker_19.ggMarkerInstances.push(me._marker_19__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_19);
		me._marker_19__active= clonedActiveElement._on;
		me._marker_19__active.style.visibility='hidden';
		me._marker_19__active.style.left='0px';
		me._marker_19__active.style.top='0px';
		me._marker_19.ggMarkerActive=me._marker_19__active;
		me._marker_19.ggMarkerInstances.push(me._marker_19__active);
		if (me._marker_19.firstChild) {
			me._marker_19.insertBefore(me._marker_19__active,me._marker_19.firstChild);
		} else {
			me._marker_19.appendChild(me._marker_19__active);
		}
		if (me._marker_19.firstChild) {
			me._marker_19.insertBefore(me._marker_19__normal,me._marker_19.firstChild);
		} else {
			me._marker_19.appendChild(me._marker_19__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_20);
		me._marker_20__normal = clonedNormalElement._off;
		me._marker_20__normal.style.visibility='inherit';
		me._marker_20__normal.style.left='0px';
		me._marker_20__normal.style.top='0px';
		me._marker_20.ggMarkerNormal=me._marker_20__normal;
		me._marker_20.ggMarkerInstances.push(me._marker_20__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_20);
		me._marker_20__active= clonedActiveElement._on;
		me._marker_20__active.style.visibility='hidden';
		me._marker_20__active.style.left='0px';
		me._marker_20__active.style.top='0px';
		me._marker_20.ggMarkerActive=me._marker_20__active;
		me._marker_20.ggMarkerInstances.push(me._marker_20__active);
		if (me._marker_20.firstChild) {
			me._marker_20.insertBefore(me._marker_20__active,me._marker_20.firstChild);
		} else {
			me._marker_20.appendChild(me._marker_20__active);
		}
		if (me._marker_20.firstChild) {
			me._marker_20.insertBefore(me._marker_20__normal,me._marker_20.firstChild);
		} else {
			me._marker_20.appendChild(me._marker_20__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_21);
		me._marker_21__normal = clonedNormalElement._off;
		me._marker_21__normal.style.visibility='inherit';
		me._marker_21__normal.style.left='0px';
		me._marker_21__normal.style.top='0px';
		me._marker_21.ggMarkerNormal=me._marker_21__normal;
		me._marker_21.ggMarkerInstances.push(me._marker_21__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_21);
		me._marker_21__active= clonedActiveElement._on;
		me._marker_21__active.style.visibility='hidden';
		me._marker_21__active.style.left='0px';
		me._marker_21__active.style.top='0px';
		me._marker_21.ggMarkerActive=me._marker_21__active;
		me._marker_21.ggMarkerInstances.push(me._marker_21__active);
		if (me._marker_21.firstChild) {
			me._marker_21.insertBefore(me._marker_21__active,me._marker_21.firstChild);
		} else {
			me._marker_21.appendChild(me._marker_21__active);
		}
		if (me._marker_21.firstChild) {
			me._marker_21.insertBefore(me._marker_21__normal,me._marker_21.firstChild);
		} else {
			me._marker_21.appendChild(me._marker_21__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_22);
		me._marker_22__normal = clonedNormalElement._off;
		me._marker_22__normal.style.visibility='inherit';
		me._marker_22__normal.style.left='0px';
		me._marker_22__normal.style.top='0px';
		me._marker_22.ggMarkerNormal=me._marker_22__normal;
		me._marker_22.ggMarkerInstances.push(me._marker_22__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_22);
		me._marker_22__active= clonedActiveElement._on;
		me._marker_22__active.style.visibility='hidden';
		me._marker_22__active.style.left='0px';
		me._marker_22__active.style.top='0px';
		me._marker_22.ggMarkerActive=me._marker_22__active;
		me._marker_22.ggMarkerInstances.push(me._marker_22__active);
		if (me._marker_22.firstChild) {
			me._marker_22.insertBefore(me._marker_22__active,me._marker_22.firstChild);
		} else {
			me._marker_22.appendChild(me._marker_22__active);
		}
		if (me._marker_22.firstChild) {
			me._marker_22.insertBefore(me._marker_22__normal,me._marker_22.firstChild);
		} else {
			me._marker_22.appendChild(me._marker_22__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_23);
		me._marker_23__normal = clonedNormalElement._off;
		me._marker_23__normal.style.visibility='inherit';
		me._marker_23__normal.style.left='0px';
		me._marker_23__normal.style.top='0px';
		me._marker_23.ggMarkerNormal=me._marker_23__normal;
		me._marker_23.ggMarkerInstances.push(me._marker_23__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_23);
		me._marker_23__active= clonedActiveElement._on;
		me._marker_23__active.style.visibility='hidden';
		me._marker_23__active.style.left='0px';
		me._marker_23__active.style.top='0px';
		me._marker_23.ggMarkerActive=me._marker_23__active;
		me._marker_23.ggMarkerInstances.push(me._marker_23__active);
		if (me._marker_23.firstChild) {
			me._marker_23.insertBefore(me._marker_23__active,me._marker_23.firstChild);
		} else {
			me._marker_23.appendChild(me._marker_23__active);
		}
		if (me._marker_23.firstChild) {
			me._marker_23.insertBefore(me._marker_23__normal,me._marker_23.firstChild);
		} else {
			me._marker_23.appendChild(me._marker_23__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_24);
		me._marker_24__normal = clonedNormalElement._off;
		me._marker_24__normal.style.visibility='inherit';
		me._marker_24__normal.style.left='0px';
		me._marker_24__normal.style.top='0px';
		me._marker_24.ggMarkerNormal=me._marker_24__normal;
		me._marker_24.ggMarkerInstances.push(me._marker_24__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_24);
		me._marker_24__active= clonedActiveElement._on;
		me._marker_24__active.style.visibility='hidden';
		me._marker_24__active.style.left='0px';
		me._marker_24__active.style.top='0px';
		me._marker_24.ggMarkerActive=me._marker_24__active;
		me._marker_24.ggMarkerInstances.push(me._marker_24__active);
		if (me._marker_24.firstChild) {
			me._marker_24.insertBefore(me._marker_24__active,me._marker_24.firstChild);
		} else {
			me._marker_24.appendChild(me._marker_24__active);
		}
		if (me._marker_24.firstChild) {
			me._marker_24.insertBefore(me._marker_24__normal,me._marker_24.firstChild);
		} else {
			me._marker_24.appendChild(me._marker_24__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_25);
		me._marker_25__normal = clonedNormalElement._off;
		me._marker_25__normal.style.visibility='inherit';
		me._marker_25__normal.style.left='0px';
		me._marker_25__normal.style.top='0px';
		me._marker_25.ggMarkerNormal=me._marker_25__normal;
		me._marker_25.ggMarkerInstances.push(me._marker_25__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_25);
		me._marker_25__active= clonedActiveElement._on;
		me._marker_25__active.style.visibility='hidden';
		me._marker_25__active.style.left='0px';
		me._marker_25__active.style.top='0px';
		me._marker_25.ggMarkerActive=me._marker_25__active;
		me._marker_25.ggMarkerInstances.push(me._marker_25__active);
		if (me._marker_25.firstChild) {
			me._marker_25.insertBefore(me._marker_25__active,me._marker_25.firstChild);
		} else {
			me._marker_25.appendChild(me._marker_25__active);
		}
		if (me._marker_25.firstChild) {
			me._marker_25.insertBefore(me._marker_25__normal,me._marker_25.firstChild);
		} else {
			me._marker_25.appendChild(me._marker_25__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_26);
		me._marker_26__normal = clonedNormalElement._off;
		me._marker_26__normal.style.visibility='inherit';
		me._marker_26__normal.style.left='0px';
		me._marker_26__normal.style.top='0px';
		me._marker_26.ggMarkerNormal=me._marker_26__normal;
		me._marker_26.ggMarkerInstances.push(me._marker_26__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_26);
		me._marker_26__active= clonedActiveElement._on;
		me._marker_26__active.style.visibility='hidden';
		me._marker_26__active.style.left='0px';
		me._marker_26__active.style.top='0px';
		me._marker_26.ggMarkerActive=me._marker_26__active;
		me._marker_26.ggMarkerInstances.push(me._marker_26__active);
		if (me._marker_26.firstChild) {
			me._marker_26.insertBefore(me._marker_26__active,me._marker_26.firstChild);
		} else {
			me._marker_26.appendChild(me._marker_26__active);
		}
		if (me._marker_26.firstChild) {
			me._marker_26.insertBefore(me._marker_26__normal,me._marker_26.firstChild);
		} else {
			me._marker_26.appendChild(me._marker_26__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_27);
		me._marker_27__normal = clonedNormalElement._off;
		me._marker_27__normal.style.visibility='inherit';
		me._marker_27__normal.style.left='0px';
		me._marker_27__normal.style.top='0px';
		me._marker_27.ggMarkerNormal=me._marker_27__normal;
		me._marker_27.ggMarkerInstances.push(me._marker_27__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_27);
		me._marker_27__active= clonedActiveElement._on;
		me._marker_27__active.style.visibility='hidden';
		me._marker_27__active.style.left='0px';
		me._marker_27__active.style.top='0px';
		me._marker_27.ggMarkerActive=me._marker_27__active;
		me._marker_27.ggMarkerInstances.push(me._marker_27__active);
		if (me._marker_27.firstChild) {
			me._marker_27.insertBefore(me._marker_27__active,me._marker_27.firstChild);
		} else {
			me._marker_27.appendChild(me._marker_27__active);
		}
		if (me._marker_27.firstChild) {
			me._marker_27.insertBefore(me._marker_27__normal,me._marker_27.firstChild);
		} else {
			me._marker_27.appendChild(me._marker_27__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_28);
		me._marker_28__normal = clonedNormalElement._off;
		me._marker_28__normal.style.visibility='inherit';
		me._marker_28__normal.style.left='0px';
		me._marker_28__normal.style.top='0px';
		me._marker_28.ggMarkerNormal=me._marker_28__normal;
		me._marker_28.ggMarkerInstances.push(me._marker_28__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_28);
		me._marker_28__active= clonedActiveElement._on;
		me._marker_28__active.style.visibility='hidden';
		me._marker_28__active.style.left='0px';
		me._marker_28__active.style.top='0px';
		me._marker_28.ggMarkerActive=me._marker_28__active;
		me._marker_28.ggMarkerInstances.push(me._marker_28__active);
		if (me._marker_28.firstChild) {
			me._marker_28.insertBefore(me._marker_28__active,me._marker_28.firstChild);
		} else {
			me._marker_28.appendChild(me._marker_28__active);
		}
		if (me._marker_28.firstChild) {
			me._marker_28.insertBefore(me._marker_28__normal,me._marker_28.firstChild);
		} else {
			me._marker_28.appendChild(me._marker_28__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_29);
		me._marker_29__normal = clonedNormalElement._off;
		me._marker_29__normal.style.visibility='inherit';
		me._marker_29__normal.style.left='0px';
		me._marker_29__normal.style.top='0px';
		me._marker_29.ggMarkerNormal=me._marker_29__normal;
		me._marker_29.ggMarkerInstances.push(me._marker_29__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_29);
		me._marker_29__active= clonedActiveElement._on;
		me._marker_29__active.style.visibility='hidden';
		me._marker_29__active.style.left='0px';
		me._marker_29__active.style.top='0px';
		me._marker_29.ggMarkerActive=me._marker_29__active;
		me._marker_29.ggMarkerInstances.push(me._marker_29__active);
		if (me._marker_29.firstChild) {
			me._marker_29.insertBefore(me._marker_29__active,me._marker_29.firstChild);
		} else {
			me._marker_29.appendChild(me._marker_29__active);
		}
		if (me._marker_29.firstChild) {
			me._marker_29.insertBefore(me._marker_29__normal,me._marker_29.firstChild);
		} else {
			me._marker_29.appendChild(me._marker_29__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_30);
		me._marker_30__normal = clonedNormalElement._off;
		me._marker_30__normal.style.visibility='inherit';
		me._marker_30__normal.style.left='0px';
		me._marker_30__normal.style.top='0px';
		me._marker_30.ggMarkerNormal=me._marker_30__normal;
		me._marker_30.ggMarkerInstances.push(me._marker_30__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_30);
		me._marker_30__active= clonedActiveElement._on;
		me._marker_30__active.style.visibility='hidden';
		me._marker_30__active.style.left='0px';
		me._marker_30__active.style.top='0px';
		me._marker_30.ggMarkerActive=me._marker_30__active;
		me._marker_30.ggMarkerInstances.push(me._marker_30__active);
		if (me._marker_30.firstChild) {
			me._marker_30.insertBefore(me._marker_30__active,me._marker_30.firstChild);
		} else {
			me._marker_30.appendChild(me._marker_30__active);
		}
		if (me._marker_30.firstChild) {
			me._marker_30.insertBefore(me._marker_30__normal,me._marker_30.firstChild);
		} else {
			me._marker_30.appendChild(me._marker_30__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_32);
		me._marker_32__normal = clonedNormalElement._off;
		me._marker_32__normal.style.visibility='inherit';
		me._marker_32__normal.style.left='0px';
		me._marker_32__normal.style.top='0px';
		me._marker_32.ggMarkerNormal=me._marker_32__normal;
		me._marker_32.ggMarkerInstances.push(me._marker_32__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_32);
		me._marker_32__active= clonedActiveElement._on;
		me._marker_32__active.style.visibility='hidden';
		me._marker_32__active.style.left='0px';
		me._marker_32__active.style.top='0px';
		me._marker_32.ggMarkerActive=me._marker_32__active;
		me._marker_32.ggMarkerInstances.push(me._marker_32__active);
		if (me._marker_32.firstChild) {
			me._marker_32.insertBefore(me._marker_32__active,me._marker_32.firstChild);
		} else {
			me._marker_32.appendChild(me._marker_32__active);
		}
		if (me._marker_32.firstChild) {
			me._marker_32.insertBefore(me._marker_32__normal,me._marker_32.firstChild);
		} else {
			me._marker_32.appendChild(me._marker_32__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_33);
		me._marker_33__normal = clonedNormalElement._off;
		me._marker_33__normal.style.visibility='inherit';
		me._marker_33__normal.style.left='0px';
		me._marker_33__normal.style.top='0px';
		me._marker_33.ggMarkerNormal=me._marker_33__normal;
		me._marker_33.ggMarkerInstances.push(me._marker_33__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_33);
		me._marker_33__active= clonedActiveElement._on;
		me._marker_33__active.style.visibility='hidden';
		me._marker_33__active.style.left='0px';
		me._marker_33__active.style.top='0px';
		me._marker_33.ggMarkerActive=me._marker_33__active;
		me._marker_33.ggMarkerInstances.push(me._marker_33__active);
		if (me._marker_33.firstChild) {
			me._marker_33.insertBefore(me._marker_33__active,me._marker_33.firstChild);
		} else {
			me._marker_33.appendChild(me._marker_33__active);
		}
		if (me._marker_33.firstChild) {
			me._marker_33.insertBefore(me._marker_33__normal,me._marker_33.firstChild);
		} else {
			me._marker_33.appendChild(me._marker_33__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_34);
		me._marker_34__normal = clonedNormalElement._off;
		me._marker_34__normal.style.visibility='inherit';
		me._marker_34__normal.style.left='0px';
		me._marker_34__normal.style.top='0px';
		me._marker_34.ggMarkerNormal=me._marker_34__normal;
		me._marker_34.ggMarkerInstances.push(me._marker_34__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_34);
		me._marker_34__active= clonedActiveElement._on;
		me._marker_34__active.style.visibility='hidden';
		me._marker_34__active.style.left='0px';
		me._marker_34__active.style.top='0px';
		me._marker_34.ggMarkerActive=me._marker_34__active;
		me._marker_34.ggMarkerInstances.push(me._marker_34__active);
		if (me._marker_34.firstChild) {
			me._marker_34.insertBefore(me._marker_34__active,me._marker_34.firstChild);
		} else {
			me._marker_34.appendChild(me._marker_34__active);
		}
		if (me._marker_34.firstChild) {
			me._marker_34.insertBefore(me._marker_34__normal,me._marker_34.firstChild);
		} else {
			me._marker_34.appendChild(me._marker_34__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_31);
		me._marker_31__normal = clonedNormalElement._off;
		me._marker_31__normal.style.visibility='inherit';
		me._marker_31__normal.style.left='0px';
		me._marker_31__normal.style.top='0px';
		me._marker_31.ggMarkerNormal=me._marker_31__normal;
		me._marker_31.ggMarkerInstances.push(me._marker_31__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_31);
		me._marker_31__active= clonedActiveElement._on;
		me._marker_31__active.style.visibility='hidden';
		me._marker_31__active.style.left='0px';
		me._marker_31__active.style.top='0px';
		me._marker_31.ggMarkerActive=me._marker_31__active;
		me._marker_31.ggMarkerInstances.push(me._marker_31__active);
		if (me._marker_31.firstChild) {
			me._marker_31.insertBefore(me._marker_31__active,me._marker_31.firstChild);
		} else {
			me._marker_31.appendChild(me._marker_31__active);
		}
		if (me._marker_31.firstChild) {
			me._marker_31.insertBefore(me._marker_31__normal,me._marker_31.firstChild);
		} else {
			me._marker_31.appendChild(me._marker_31__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_35);
		me._marker_35__normal = clonedNormalElement._off;
		me._marker_35__normal.style.visibility='inherit';
		me._marker_35__normal.style.left='0px';
		me._marker_35__normal.style.top='0px';
		me._marker_35.ggMarkerNormal=me._marker_35__normal;
		me._marker_35.ggMarkerInstances.push(me._marker_35__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_35);
		me._marker_35__active= clonedActiveElement._on;
		me._marker_35__active.style.visibility='hidden';
		me._marker_35__active.style.left='0px';
		me._marker_35__active.style.top='0px';
		me._marker_35.ggMarkerActive=me._marker_35__active;
		me._marker_35.ggMarkerInstances.push(me._marker_35__active);
		if (me._marker_35.firstChild) {
			me._marker_35.insertBefore(me._marker_35__active,me._marker_35.firstChild);
		} else {
			me._marker_35.appendChild(me._marker_35__active);
		}
		if (me._marker_35.firstChild) {
			me._marker_35.insertBefore(me._marker_35__normal,me._marker_35.firstChild);
		} else {
			me._marker_35.appendChild(me._marker_35__normal);
		}
		var clonedNormalElement = new SkinElement_off_Class(this,me._marker_36);
		me._marker_36__normal = clonedNormalElement._off;
		me._marker_36__normal.style.visibility='inherit';
		me._marker_36__normal.style.left='0px';
		me._marker_36__normal.style.top='0px';
		me._marker_36.ggMarkerNormal=me._marker_36__normal;
		me._marker_36.ggMarkerInstances.push(me._marker_36__normal);
		var clonedActiveElement = new SkinElement_on_Class(this,me._marker_36);
		me._marker_36__active= clonedActiveElement._on;
		me._marker_36__active.style.visibility='hidden';
		me._marker_36__active.style.left='0px';
		me._marker_36__active.style.top='0px';
		me._marker_36.ggMarkerActive=me._marker_36__active;
		me._marker_36.ggMarkerInstances.push(me._marker_36__active);
		if (me._marker_36.firstChild) {
			me._marker_36.insertBefore(me._marker_36__active,me._marker_36.firstChild);
		} else {
			me._marker_36.appendChild(me._marker_36__active);
		}
		if (me._marker_36.firstChild) {
			me._marker_36.insertBefore(me._marker_36__normal,me._marker_36.firstChild);
		} else {
			me._marker_36.appendChild(me._marker_36__normal);
		}
	...
	function SkinElement_off_Class(parentScope,ggParent) {
		var me=this;
		var flag=false;
		me.parentScope=parentScope;
		...
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'+RWAi4wxaf7EHiVIB0tNSE9Pz7FBEHwMwMcAnDjUv0NEMYCb8/n8zXqvlZoIHSzVNHEcn5DL5U6o1+t/RkS/BbAlSZLN5XL519JtKhv+P8fsQXwJ7X3DAAAAAElFTkSuQmCC';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_image';
	...
	function SkinElement_on_Class(parentScope,ggParent) {
		var me=this;
		var flag=false;
		me.parentScope=parentScope;
		me.ggParent=ggParent;
		...
		hs='data:image/png;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'F9xx4lSwdL7ZEJS4qNyV76NhN/G8D0Qf5rvwPTTc5evTd1nqT3WqnR08FSFTOxsK4JCJoC5mlE5IcB2hPJsFjKNv1Nuk3Fw/8HyXpFcS3yDCIAAAAASUVORK5CYII=';
		els.setAttribute('src',hs);
		els.ggNormalSrc=hs;
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;');
		els.className='ggskin ggskin_image';
	...
	player.addListener('changenodeid', function(args) { me.callChildLogicBlocksHotspot_ht_node_changenodeid();me.callChildLogicBlocksHotspot_ht_url_changenodeid();me.callChildLogicBlocksHotspot_ht_info_changenodeid();me.callChildLogicBlocksHotspot_ht_image_changenodeid(); });
	player.addListener('configloaded', function(args) { me.callChildLogicBlocksHotspot_ht_node_configloaded();me.callChildLogicBlocksHotspot_ht_url_configloaded();me.callChildLogicBlocksHotspot_ht_info_configloaded();me.callChildLogicBlocksHotspot_ht_image_configloaded(); });
	...
	player.addListener('varchanged_vis_video_popup_file', function(args) { me.callChildLogicBlocksHotspot_ht_node_varchanged_vis_video_popup_file();me.callChildLogicBlocksHotspot_ht_url_varchanged_vis_video_popup_file();me.callChildLogicBlocksHotspot_ht_info_varchanged_vis_video_popup_file();me.callChildLogicBlocksHotspot_ht_image_varchanged_vis_video_popup_file(); });
	...
	player.addListener('varchanged_vis_video_popup_youtube', function(args) { me.callChildLogicBlocksHotspot_ht_node_varchanged_vis_video_popup_youtube();me.callChildLogicBlocksHotspot_ht_url_varchanged_vis_video_popup_youtube();me.callChildLogicBlocksHotspot_ht_info_varchanged_vis_video_popup_youtube();me.callChildLogicBlocksHotspot_ht_image_varchanged_vis_video_popup_youtube(); });
	...
	player.addListener('varchanged_vis_timer', function(args) { me.callChildLogicBlocksHotspot_ht_node_varchanged_vis_timer();me.callChildLogicBlocksHotspot_ht_url_varchanged_vis_timer();me.callChildLogicBlocksHotspot_ht_info_varchanged_vis_timer();me.callChildLogicBlocksHotspot_ht_image_varchanged_vis_timer(); });
